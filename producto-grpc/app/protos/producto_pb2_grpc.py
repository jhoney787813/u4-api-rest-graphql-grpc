...
class ProductoServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.DeleteProducto = channel.unary_unary(
                ...
                _registered_method=True)
        self.ListProductosGraphQL = channel.unary_unary(
                '/producto.ProductoService/ListProductosGraphQL',
                request_serializer=producto__pb2.Empty.SerializeToString,
                response_deserializer=producto__pb2.ProductoList.FromString,
                _registered_method=True)
...
def add_ProductoServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ListProductosGraphQL': grpc.unary_unary_rpc_method_handler(
                    servicer.ListProductosGraphQL,
                    request_deserializer=producto__pb2.Empty.FromString,
                    response_serializer=producto__pb2.ProductoList.SerializeToString,
            ),
    }
...
class ProductoService(object):
    ...
    @staticmethod
    def ListProductosGraphQL(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
